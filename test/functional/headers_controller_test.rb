...
class HeadersControllerTest < ActionController::TestCase
  ...
  test "should create header" do
    assert_difference('Header.count') do
      post :create, header: { extra: @header.extra, extram: @header.extram, img: @header.img, text: @header.text }
    end
  ...
  test "should update header" do
    put :update, id: @header, header: { extra: @header.extra, extram: @header.extram, img: @header.img, text: @header.text }
    assert_redirected_to header_path(assigns(:header))
  end
